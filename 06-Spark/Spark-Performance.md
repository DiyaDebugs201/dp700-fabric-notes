...
- Spark performance depends heavily on good partitioning.
- Cache reused DataFrames.
- Persist offers flexible storage.
- Filter early and read only needed columns.
- Shuffles are expensive.
- Broadcast small lookup tables.
- OPTIMIZE compacts Delta files.
- Z-ORDER speeds up filtered queries.
- VACUUM removes obsolete files.
- ANALYZE TABLE improves query planning.
- DESCRIBE HISTORY shows Delta transaction history.
